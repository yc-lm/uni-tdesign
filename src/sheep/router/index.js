import { clone, isEmpty, isNil, isNumber, isObject, isString, startsWith } from 'lodash';
...
const _go = (
    ...
    // 使用redirect跳转
    if (options.back && hasHistory()) {
        // 带动画跳转参数
        const jumpParams = {};
        if (options.animationType) {
            jumpParams.animationType = options.animationType;
        }
        uni.navigateBack(jumpParams);
        return;
    }
